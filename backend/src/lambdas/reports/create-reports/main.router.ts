import { getHeaders, getQueryStringsParams, getServerContext, sendResponse } from '~/common/serverUtils';
...
router.post('/create-reports', async (req: Request, res: Response) => {
  try {

    const event: APIGatewayProxyEventV2 = {
      version: '2.0',
      routeKey: '$default',
      rawPath: '/create-reports',
      rawQueryString: '',
